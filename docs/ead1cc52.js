...
`;customElements.define("todo-app",class extends F{static get properties(){return{tasks:{type:Array,attribute:!1,converter:t=>JSON.parse(t).map(((t,e)=>({id:e+1,task:t,completed:!1})))},thereAreDoneTasks:{type:Boolean,attribute:!1},thereAreUndoneTasks:{type:Boolean,attribute:!1}}}static get styles(){return et}constructor(){super(),this.title="Todo app",this.tasks=[],this.thereAreDoneTasks=!1,this.thereAreUndoneTasks=!1}tasksTemplate(t){return this.tasks.filter((e=>e.completed===t)).map((t=>U`
    ...
    `}}),customElements.define("new-todo",class extends F{static get properties(){return{inputVal:{type:String,attribute:!1}}}static get styles(){return et}constructor(){super(),this.inputVal=""}notifyNewTodo(){this.dispatchEvent(new CustomEvent("add-todo",{detail:{taskName:this.inputVal}})),this.inputVal=""}handleNewTaskInput(t){this.inputVal=t.target.value,this.inputVal&&"Enter"===t.key&&this.notifyNewTodo()}handleAddClick(t){return t.preventDefault(),this.inputVal&&this.notifyNewTodo()}render(){return U`
        ...
        `}}),customElements.define("todo-item",class extends F{static get properties(){return{task:{type:Object}}}static get styles(){return et}constructor(){super(),this.task={}}emitId(t){this.dispatchEvent(new CustomEvent(t,{detail:{todoId:this.task.id}}))}notifyDeleteTodo(){this.emitId("delete-todo")}notifyToogleTodo(){this.emitId("toogle-todo")}render(){return U`
            <h4>${this.task.task}</h4>
            <div class="todo-options">
                <a
                    href='#'
                    @click=${this.notifyToogleTodo}>${this.task.completed?X:Y}
                </a>
